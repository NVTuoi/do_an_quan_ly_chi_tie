...
class CategorySpendBloc extends Bloc<CategorySpendEvent, CategorySpendState> {
  ...
  Stream<CategorySpendState> _mapCreateCategorySpendToState(
      CreateCategorySpendEvent event) async* {
  ...
  Stream<CategorySpendState> _mapGetCategorySpendsToState(
  ...
  Stream<CategorySpendState> _mapUpdateCategorySpendToState(
      UpdateCategorySpendEvent event) async* {
    yield UpdateCategorySpendLoadingState();
    try {
      await categorySpendRepository.updateCategorySpend(
          categorySpend: event.categorySpend);
  ...
  Stream<CategorySpendState> _mapDeleteCategorySpendToState(
      DeleteCategorySpendEvent event) async* {
    yield DeleteCategorySpendLoadingState();
    try {
      await categorySpendRepository.deleteCategorySpend(
          categorySpend: event.categorySpend);
